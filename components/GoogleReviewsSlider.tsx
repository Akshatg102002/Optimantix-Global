...
const REVIEWS = [
  {
    ...
    profilePic: "https://ui-avatars.com/api/?name=Sarah+Jenkins&background=random",
    time: "2 weeks ago",
    text: "Optimantix Global completely transformed our digital presence. Their SEO strategy drove a 150% increase in traffic in just a few months. Highly recommended!",
    rating: 5,
  },
  {
    id: 2,
    author: "David Chen",
    profilePic: "https://ui-avatars.com/api/?name=David+Chen&background=random",
    time: "1 month ago",
    text: "The web development team delivered an exceptional headless commerce platform for us. Fast, scalable, and beautifully designed. Top tier service.",
    rating: 5,
  },
  {
    id: 3,
    author: "Elena Rodriguez",
    profilePic: "https://ui-avatars.com/api/?name=Elena+Rodriguez&background=random",
    time: "3 months ago",
    text: "We struggled with Amazon PPC until we hired Optimantix. They lowered our ACoS to 12% and scaled our sales exponentially.",
    rating: 5,
  },
  {
    id: 4,
    author: "Michael Thompson",
    profilePic: "https://ui-avatars.com/api/?name=Michael+Thompson&background=random",
    time: "1 month ago",
    text: "Very professional team. They listened to our requirements carefully and delivered Google Workspace migration with zero downtime.",
    rating: 5,
  },
  {
    id: 5,
    author: "Jessica Wong",
    profilePic: "https://ui-avatars.com/api/?name=Jessica+Wong&background=random",
    time: "2 months ago",
    text: "Our social media engagement tripled after partnering with them. Fantastic creative team that truly understands modern algorithms.",
    rating: 5,
  }
];
