              ...
              >
                ...
                <div className="absolute inset-0 z-0">
                    <img 
                        ...
                        alt={service.title}
                        className="w-full h-full object-cover opacity-10 group-hover:opacity-20 group-hover:scale-105 transition-all duration-700 filter grayscale" 
                    />
                    {/* Stronger gradient at bottom for text readability */}
                    <div className="absolute inset-0 bg-gradient-to-b from-[#0e0e0e]/80 via-[#0e0e0e]/90 to-[#0e0e0e]"></div>
                </div>
                ...
                <div className="relative z-10 flex flex-col h-full">
                    ...
                    <div className="flex-grow">
                        {service.subServices && service.subServices.length > 0 ? (
                            <div className="flex flex-wrap gap-2 mb-8">
                                {service.subServices.map(sub => (
                                    <Link 
                                        ...
                                        className="text-xs font-medium px-4 py-2 rounded-full bg-white/5 hover:bg-white/15 text-gray-300 border border-white/10 transition-all hover:border-primary/50 hover:text-white"
                                    >
                                        {sub.title}
                                    </Link>
                                ))}
                           ...
                           // Placeholder for empty sub-services to maintain layout
